pipeline {
    ...
    parameters {
        string(name: 'EC2_IP', defaultValue: '172.31.34.253', description: 'EC2 Instance IP Address')
        string(name: 'GIT_BRANCH', defaultValue: 'jenkins', description: 'Git Branch to checkout')
        string(name: 'GIT_URL', defaultValue: 'https://github.com/Gabriel-Obute/jenkins_deploy_ec2.git', description: 'Git Repository URL')
